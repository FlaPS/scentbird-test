...
export const SVGLibrary = {
    RatingStar: (props: SvgIconProps) =>
        <svg width='13' height='13' viewBox='0 0 13 13' fill='#DDDDDD' xmlns='http://www.w3.org/2000/svg' {...props}>
    ...
    ForwardIcon: (props: SvgIconProps) =>
        <svg width='22' height='16' viewBox='0 0 22 16' fill='white' xmlns='http://www.w3.org/2000/svg' {...props}>
            <path fillRule='evenodd' clipRule='evenodd'
                  d='M13.4141 0.0495758L21.0391 8.03009L18.0523 7.99994L11.9998 1.46379L13.4141 0.0495758Z'/>
            <path fillRule='evenodd' clipRule='evenodd'
                  d='M21.0441 8.00561L13.4141 15.9165L11.9999 14.5023L18.1265 7.98828L21.0441 8.00561Z'/>
