...
export type ExtractAction<T> =
    T extends TypedReducer<infer S, infer A>
...
type ActionCreatorMap<M, T, P> = {
    [K in keyof M]: ActionCreator<P>
}
export type ExtractActionByFactory<M> =
    M extends ActionCreatorMap<M, infer T, infer P>
