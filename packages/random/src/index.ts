...
const takeRandomArray = <T>(max: number | undefined = undefined, min: number = 0, array: T[]): T[] => {
...
export const takeRandom =
    (max: number | undefined = undefined, min: number = 0) => <T>(source: T[] | utils.AssociativeArray<T>): T[]  =>
        // @ts-ignore
